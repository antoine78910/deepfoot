...
-- Résultats de matchs (historique)
...
-- H2H agrégé (optionnel, peut être dérivé de results)
...
-- Profils utilisateur (extension auth.users)
...
-- Log des analyses (audit + déduplication)
